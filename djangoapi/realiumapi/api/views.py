...
class TokenView(generics.GenericAPIView):
    ...
    search_fields = ['listed', 'listedPrice', 'purchasedPrice', 'property__propertyName','property__avalancheAssetId','tokenId','owner__fullName','owner__email','owner__realiumUserId','property__city','property__zipCode','property__streetAddress','property__state','property__yearBuilt','property__country','acerage','property__listingType','property__propertyType']
